...
const FullLoadingScreen: React.FC = () => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-200 dark:bg-gray-950">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-sm font-medium text-gray-800 dark:text-gray-300">Loading...</p>
      </div>
    </div>
  );
};
