// src/components/alerts/DeleteAlert.tsx
...
interface DeleteAlertProps {
  ...
  title?: string;
  message?: string;
  itemName?: string; // e.g., expense description for specificity
  confirmText?: string;
  cancelText?: string;
}
...
const DeleteAlert: React.FC<DeleteAlertProps> = ({
  ...
  // Dynamic message with item name if provided
    ...
    <div className="text-center">
      ...
      <div className="mt-7 flex w-full items-center justify-center gap-3">
        <button
          type="button"
          onClick={onClose}
          className="w-full rounded-lg bg-gray-200 px-4 py-3 text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 sm:w-auto"
        >
          {cancelText}
        </button>
        <button
